  ...
  return (
    <div className="flex justify-center items-center w-screen h-20 bg-slate-200">
      <div className=" flex items-center px-4 w-[76vw] h-20">
        <div className="flex justify-center items-center w-[300px] bg-white text-[#2e3192] rounded-lg">
        ...
        <div className="w-[45.5vw] mx-5 bg-white h-14 flex rounded-lg justify-center items-center">
          <AiOutlineSearch size={40} className="text-slate-300" />
          <input
            type="text"
            className="w-full h-10 rounded-lg text-xl"
